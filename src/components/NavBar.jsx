  ...
  return (
    <header className="relative z-10 flex items-center justify-between w-full px-32 py-8 font-medium dark:text-light lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="flex items-center justify-between w-full lg:hidden">
        <nav>
          <CustomLink href="/" title={t("nav.home")} className="mr-4" />
          <CustomLink href="/about" title={t("nav.about")} className="mx-4" />
          <CustomLink
            href="/projects"
        ...
        <nav className="flex flex-wrap items-center justify-center">
          ...
          <motion.a
            href="https://www.linkedin.com/in/tee-chee-zhang-jerry/"
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 ml-1"
        ...
        >
          ...
          <nav className="flex flex-wrap items-center justify-center mt-2">
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 mr-3 rounded-full sm:mx-1 bg-light dark:bg-dark"
            >
              <GithubIcon />
            </motion.a>
            <motion.a
